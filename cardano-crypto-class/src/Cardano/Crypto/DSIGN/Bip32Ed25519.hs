...
module Cardano.Crypto.DSIGN.Bip32Ed25519
  ( Bip32Ed25519DSIGN
  , SigDSIGN (..)
  , SignKeyDSIGN (..)
  , VerKeyDSIGN (..)
...
instance DSIGNAlgorithm Bip32Ed25519DSIGN where
    ...
    type SeedSizeDSIGN Bip32Ed25519DSIGN = 32
    ...
    type SizeVerKeyDSIGN Bip32Ed25519DSIGN = 64

    -- | BIP32-Ed25519 extended signing key size is 96 octets.
    type SizeSignKeyDSIGN Bip32Ed25519DSIGN = 96

    -- | BIP32-Ed25519 extended signature size is 64 octets.
    type SizeSigDSIGN Bip32Ed25519DSIGN = 64
