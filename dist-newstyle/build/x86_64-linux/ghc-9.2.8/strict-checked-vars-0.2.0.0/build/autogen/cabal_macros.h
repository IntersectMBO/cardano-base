...
/* package strict-mvar-1.4.0.0 */
#ifndef VERSION_strict_mvar
#define VERSION_strict_mvar "1.4.0.0"
#endif /* VERSION_strict_mvar */
#ifndef MIN_VERSION_strict_mvar
#define MIN_VERSION_strict_mvar(major1,major2,minor) (\
  (major1) <  1 || \
  (major1) == 1 && (major2) <  4 || \
  (major1) == 1 && (major2) == 4 && (minor) <= 0)
#endif /* MIN_VERSION_strict_mvar */
/* package strict-stm-1.4.0.0 */
#ifndef VERSION_strict_stm
#define VERSION_strict_stm "1.4.0.0"
...
#define CURRENT_PACKAGE_KEY "strict-checked-vars-0.2.0.0-inplace"
#endif /* CURRENT_packageKey */
#ifndef CURRENT_COMPONENT_ID
#define CURRENT_COMPONENT_ID "strict-checked-vars-0.2.0.0-inplace"
