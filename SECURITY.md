...
The Cardano open source project cardano-base is committed to ensuring the security of
...
If you discover a security vulnerability in cardano-base, we encourage you to
responsibly disclose it to us. To report a vulnerability, please use
the [private reporting form on GitHub](https://github.com/IntersectMBO/cardano-base/security/advisories/new)
...
on the [cardano-base repository](https://github.com/IntersectMBO/cardano-base).

## Conclusion

The cardano-base project greatly appreciates the assistance of the security
