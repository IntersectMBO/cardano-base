...
If you discover a security vulnerability in cardano-base, we encourage you to responsibly disclose it to us. To report a vulnerability, please use the [private reporting form on GitHub](https://github.com/IntersectMBO/cardano-base/security/advisories/new) to draft a new _Security advisory_.
...
To report a security vulnerability, please use the [GitHub security advisory form](https://github.com/IntersectMBO/cardano-base/security/advisories/new). Should you experience any issues reporting via GitHub or have other questions, please contact [security@intersectmbo.org](mailto:security@intersectmbo.org).

## Revision of Policy

This Security Vulnerability Disclosure Policy may be updated or revised as necessary. Please check the latest version of this policy on the [cardano-base repository](https://github.com/IntersectMBO/cardano-base).

## Conclusion

The cardano-base project greatly appreciates the assistance of the security community in helping us maintain the security of our software while upholding the highest standards of privacy. Together, we can work to identify and address vulnerabilities, ensuring a safer and more secure experience for all users.
